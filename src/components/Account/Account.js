  ...
  return (
    <div id='accountContainer'>
      {currentUser.username !== 'guest' ? (
        <h2 id='personalWelcome'>
          Welcome to your account, <span>{currentUser.username}</span>!
        </h2>
      ) : (
        <div id='accountWelcome'>
          ...
          <h2 id='welcomeHeading'>
            Grandma Mac is always happy to sense a new customer!
          </h2>
          <p id='welcomeSubHeading'>
            <NavLink id='loginButton' to='/login'>
              Login
            </NavLink>{' '}
            or{' '}
            <NavLink id='registerButton' to='/register'>
              Register
            </NavLink>
            to see personalized account information and keep track of your Mac!
          </p>
        </div>
      )}
      ...
      {currentUser.username !== 'guest' && currentUser.admin !== true ? (
        <div className='accountInformation'>
          <div className='accountInformationNav'>
            <button id='navOrderHistory' onClick={showOrderHistory}>
              Order History
            </button>
            <button id='navEditUser' onClick={showEditUserForm}>
